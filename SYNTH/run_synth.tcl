...
set CLK_PERIOD [expr {15600}];

set SLW_PDK_LIB "/root/Work/vlsi/pdks/open_pdks/sky130/sky130B/libs.ref/sky130_fd_sc_hdll/lib/sky130_fd_sc_hdll__ss_100C_1v60.lib"
set TYP_PDK_LIB "/root/Work/vlsi/pdks/open_pdks/sky130/sky130B/libs.ref/sky130_fd_sc_hdll/lib/sky130_fd_sc_hdll__tt_025C_1v80.lib"
set FST_PDK_LIB "/root/Work/vlsi/pdks/open_pdks/sky130/sky130B/libs.ref/sky130_fd_sc_hdll/lib/sky130_fd_sc_hdll__ff_n40C_1v95.lib"
...
foreach {corner_name corner_lib} $corners {
    ...
    abc -liberty $corner_lib -D ${CLK_PERIOD} -clk clk -constr ${ABC_FILE} -script ${ABC_SET}
