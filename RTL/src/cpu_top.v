...
(
    ...
    assign a_idx = instr_decode[(2*REG_W)+IMMD_W-1:REG_W+IMMD_W];
    assign b_idx = instr_decode[(REG_W*2)-1:REG_W];
    assign c_idx = instr_decode[REG_W-1:0];
    assign immd  = instr_decode[REG_W+IMMD_W-1:REG_W];
